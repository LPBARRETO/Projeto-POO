...
public class CadastroMedicosServlet extends UsuarioCrudServlet<Medico> {

    private final MedicoService service = new MedicoService();

    @Override
    protected UsuarioService<Medico> getService() {
        return service;
    }
    ...
    protected Medico criarUsuario(HttpServletRequest request) {
        ...
        return new Medico(id, nome, email, cpf, celular, senha);
    }
}
